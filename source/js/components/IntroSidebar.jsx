  ...
  render () {
    return (
      <section className="sidebar layout-sidebar">
        <h1> About the Health Index Score </h1>
        <div>
          <p>
          ...
          <p>
            The relative rankings were calculated by analyzing dissolved oxygen, water clarity, and pH data from shoreside sites that our volunteer Citizen Stewards monitored from 2005-2015.  The values we chose to use were the 90th percentile of the dissolved oxygen percent saturation, the mean of the Secchi depth, and the mean of the diurnal differences in pH.
          </p>
          <p>
